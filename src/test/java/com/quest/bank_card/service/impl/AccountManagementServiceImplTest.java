...
public class AccountManagementServiceImplTest extends BankCardApplicationTests {
    ...
    public void saveCardTest() {
        ...
        card = accountManagementService.saveCard(UUID.fromString("d17ba058-3684-41cc-9cdb-3ea95d0a9d6f"), card);
    ...
    @Test
    public void deleteCardByIdNegativeTest_nonZeroBalance() {
    ...
    @Test
    public void deleteCardByIdPositiveTest() {
        accountManagementService.deleteCardById(UUID.fromString("aaaaaab1-15a3-4a5f-8f0c-1a2dfc80cc6a"),
    ...
    @Test
    public void deleteCardByIdNegativeTest_doesNotBelongToUser() {
